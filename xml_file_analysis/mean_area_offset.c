...
{   TFile *f = new TFile("area_offset_cancel.root","recreate");
    ...
    for(int i = 0; i < 4; i++)
    {
        ...
        TFile *file2 = new TFile("area_offset_cancel.root","update"); // updating root file (adding new trees)
...
//            cout << dt << endl;
            ...
            // find the offset (250 is the minimum time before photon peak occurs)
