...
void mean_area()
{   TFile *f = new TFile("area_area.root","recreate");
    f->Close();
    for(int i = 0; i < 4; i++)
    {
        int input = 800+50*i;
        ...
        TFile *file2 = new TFile("area_area.root","update");
...
//            cout << dt << endl;
    ...
    //         cout << channel1_area << "  " << channel2_area << "  " << channel3_area << endl;
        ...
        double end_1    = *max_element(ch1_area.begin(), ch1_area.end()) + 1000;
//        cout << "start is " << start_1 << endl;
        double start_23 = *min_element(ch2_area.begin(), ch2_area.end()) - 1000;
        double end_23   = *max_element(ch2_area.begin(), ch2_area.end()) + 1000;
        double division = 200;
        
        TH1F *hist1 = new TH1F(histname1,histname1,division, -10000, 0);
        TH1F *hist2 = new TH1F(histname2,histname2,division, -20000, -2000);
        TH1F *hist3 = new TH1F(histname3,histname3,division, -20000, -2000);
