...
void mean_area_offset_dark_current()
{   TFile *f = new TFile("area_noise_time_correction_time_-5_5.root","recreate");
    f->Close();
    for(int i = 0; i < 4; i++)
    {
        int input = 1300+50*i;
        ...
        TFile *file2 = new TFile("area_noise_time_correction_time_-5_5.root","update"); // updating root file (adding new trees)
